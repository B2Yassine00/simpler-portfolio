                ...
                <div className={`absolute inset-0 top-[120px] lg:flex justify-center gap-20 max-w-7xl mx-auto ${styles.paddingX} items-center`}>
                    ...
                    <div className="text-center mt-8 lg:mt-0">
                        ...
                        <div className="flex justify-center gap-4">    
                            <button className="p-4 w-32 border-2 text-[13.3333px] border-black rounded-[2rem] font-semibold transition-all ease-in-out duration-300 hover:bg-black hover:text-white hover:">
                                Download CV    
                            </button>
